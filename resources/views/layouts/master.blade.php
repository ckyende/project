...
<head>
	...
	<meta name="description" content="GBHL Admin Template">
	<meta name="keywords" content="admin, estimates, bootstrap, business, corporate, creative, management, minimal, modern, accounts, invoice, html5, responsive, CRM, Projects">
	<meta name="author" content="GBHL Admin Template">
	<meta name="robots" content="noindex, nofollow">
	<title>Dashboard - GBHL Labour</title>
	<!-- Favicon -->
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo"> <img src="{{ URL::to('assets/img/logo4.png') }}" width="40" height="40" alt=""> </a>
			</div>
			<!-- /Logo -->
