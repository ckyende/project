        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li> <a href="{{ route('form/position') }}"><i class="la la-rocket"></i><span> Designation </span> </span></a>
                    ...
                    <li > <a class="active" href="{{ route('schedule') }}"><i class="la la-pie-chart"></i><span> Shift & Schedule </span> </a>
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Schedule <span id="year"></span></h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{ route('schedule/save') }}" class="btn add-btn" data-toggle="modal" data-target="#add_position"><i class="fa fa-plus"></i> New </a>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('schedule/save') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="time" id="time_in" name="time_in">
                            </div>
                            <div class="form-group">
                                <label>Time Out <span class="text-danger">*</span></label>
                                <input class="form-control" type="time" id="time_out" name="time_out">
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label>Time In <span class="text-danger">*</span></label>
                                <input class="form-control datetimepicker-input" type="timepicker" id="time_in" name="time_in">
                            </div>
                            <div class="form-group">
                                <label>Time Out <span class="text-danger">*</span></label>
                                <input class="form-control" type="timepicker" id="time_out" name="time_out">
                            </div>
                            <div class="submit-section">
