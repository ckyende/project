...
@section('content')
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li><a class="active" href="{{ route('form/location') }}"><i class="la la-external-link-square"></i> <span>Location</span></a></li>
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Location <span id="year"></span></h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{ route('form/location/save') }}" class="btn add-btn" data-toggle="modal" data-target="#add_location"><i class="fa fa-plus"></i> New</a>
                        <div class="view-icons">
                            <a href="{{ route('form/location') }}" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
                    </div>
                </div>
            </div>
			<!-- /Page Header -->
                    ...
                    <div class="modal-body">
                        <form action="{{ route('form/location/save') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label>Area of Work <span class="text-danger">*</span></label>
                                <input class="form-control @error('locationName') is-invalid @enderror" type="text" id="locationName" name="locationName">
                            </div>
                        </div>
        ...
        <!-- Edit Location Modal -->
        <div class="modal custom-modal fade" id="edit_location" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
