        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li> <a class="active" href="{{ route('form/position') }}"><i class="la la-rocket"></i><span> Designation </span> </span></a>
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Designations <span id="year"></span></h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{ route('form/position/save') }}" class="btn add-btn" data-toggle="modal" data-target="#add_position"><i class="fa fa-plus"></i> New </a>
                        <div class="view-icons">
                            <a href="{{ route('form/position') }}" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-striped custom-table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Holiday Rate Per Hour</th>
                                    <th>PPE Cost Per Shift</th>
                                    <th>Management Fee Per Shift</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td >{{ $result->normal_rate }}</td>
                                    <td >{{ $result->overtime_rate }}</td>
                                    <td >{{ $result->holiday_rate }}</td>
                                    <td >{{ $result->ppe_cost }}</td>
                                    <td >{{ $result->management_fee }}</td>
                                    <td class="text-right">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('form/position/save') }}" method="POST">
                            @csrf
                           
                            <div class="form-group">
                                <label>Designation Title <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="positionName" name="positionName">
                            </div>
                            <div class="form-group">
                                <label>Normal Rate Per Hour <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="number" Step=".01" name="normal_rate">
                            </div>
                            <div class="form-group">
                                <label>Overtime Rate Per Hour <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="number" Step=".01" name="overtime_rate">
                            </div>
                            <div class="form-group">
                                <label>Holiday Rate Per Hour <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="number" Step=".01" name="holiday_rate">
                            </div>
                            <div class="form-group">
                                <label>PPE Cost Per Shift <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="number" Step=".01" name="ppe_cost">
                            </div>
                            <div class="form-group">
                                <label>management Fee Per Shift <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="number" Step=".01" name="management_fee">
                            </div>
